...
There is another point to mention: the readings in grammar can be underspecified (e.g. `verb sg''), whereas the lexicon only gives us fully specified (``verb pres p2 sg'') readings. 
