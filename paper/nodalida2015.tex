...
\todo{make this nicer: Constraint Grammar (CG)
  \cite{karlsson1995constraint} is a relatively young formalism.
In this work, we implement CG using a SAT solver,
thus relating CG to a wider context in the theory of computation.
...
\todo{Our work is inspired by \cite{lager98}, which presents constraint rules as a disjunctive logic program,
