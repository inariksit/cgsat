...
\title{Constraint Grammars as a SAT problem}
...
We represent Constraint Grammars (CG) \cite{karlsson1995constraint} 
...
Since those works, SAT solving techniques have improved significantly \cite{marques_silva2010}, and 
