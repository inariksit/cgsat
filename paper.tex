...
chosen in the previous step are shown in the angle brackets, and
syntactic labels are fully capitalised and preceded by @.
...
\cite{koskenniemi92} include also clause boundaries (TODO read about
